function results = psm_bsemp(y,x,W,ndraw,nomit,prior,impact)
...
hwait = waitbar(0,'Bayesian Spatial PSM (SEM): MCMC sampling');
t0 = clock;                  
iter = 1;
acc = 0;
...
% =========================================================================
function cout = c_sem(rho,y,x,b,sige,W,detval,vi,~,~)
